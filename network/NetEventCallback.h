...
public:
	...
	virtual void allowIncomingPacketId(RakNet::RakNetGUID const &, int) = 0;
	...
	virtual void handle(const RakNet::RakNetGUID &, ClientboundMapItemDataPacket *);
	virtual void handle(const RakNet::RakNetGUID &, RequestChunkRadiusPacket *);
	virtual void handle(const RakNet::RakNetGUID &, MapInfoRequestPacket *);
	virtual void handle(const RakNet::RakNetGUID &, ChunkRadiusUpdatedPacket *);
